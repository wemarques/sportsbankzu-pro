...
import type {
  AIAnalysis, AuditCorrection, AuditResult, MatchDetailData,
} from "@/lib/matchDetailTypes";
// Re-export temporário (#258, Commit A): dashboard/page.tsx e match/[id]/page.tsx ainda importam
// os tipos daqui; morrem inteiros no Commit B, quando este bridge some junto com o arquivo.
export type {
  AIAnalysis, AuditPickEvaluation, AuditCorrection, AuditResult, MatchDetail, MatchDetailData,
} from "@/lib/matchDetailTypes";

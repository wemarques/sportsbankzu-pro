...
def selecionar_mercados_jogo(jogo: Dict[str, Any], regime: str, volatilidade: str) -> List[Dict[str, Any]]:
    """DEPRECATED — Use selecionar_mercados_v2 from market_service instead.

    Redirects to the v2 pipeline since V3.7.
    """
    from backend.services.market_service import selecionar_mercados_v2
    return selecionar_mercados_v2(jogo, regime, volatilidade)

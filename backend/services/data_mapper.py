...
class DataMapper:
    ...
    def map_match_to_internal(api_match: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "btts_percentage_pre_match": api_match.get("btts_potential"),
            "over_15_percentage_pre_match": api_match.get("o15_potential"),
            "over_25_percentage_pre_match": api_match.get("o25_potential"),
            "over_35_percentage_pre_match": api_match.get("o35_potential"),
            "over_45_percentage_pre_match": api_match.get("o45_potential"),

                ...
                if status == "live":
                    ...
                    if not _fallback_ok:
                        ...
                        logger.warning(
                            ...
                            f"Defaulting to 0-0 fallback."
                        )
                        # Use safe fallback 0-0: match is confirmed live but API
                        # hasn't populated goal counts yet (returns -1).  Sending
                        # null caused the frontend to show "- : -" indefinitely
                        # because there was no prior score to preserve.
                        home_goals = 0
                        away_goals = 0
                        _has_goal_data = True
                else:

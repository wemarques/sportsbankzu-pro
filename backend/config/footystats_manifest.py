...
CAMPOS: Dict[str, Tuple[str, str]] = {
    ...
    "odds_ft_over05": ("CONSUMIDO", "escada de gols: par do under 0.5 para o de-vig (#237)"),
    "odds_ft_under05": ("CONSUMIDO", "escada de gols: par do over 0.5 para o de-vig (#237)"),
    "odds_ft_under15": ("CONSUMIDO", "par do Over 1.5: sem ele a ancora de mercado nao fecha (#237)"),
    "odds_ft_under35": ("CONSUMIDO", "par do Over 3.5: sem ele a ancora de mercado nao fecha (#237)"),
    "odds_ft_under45": ("CONSUMIDO", "par do Over 4.5: sem ele a ancora de mercado nao fecha (#237)"),
    "odds_doublechance_1x": ("CONSUMIDO", "odd oferecida da Dupla Chance 1X; ancora vem do trio 1X2 (#237)"),
    "odds_doublechance_12": ("CONSUMIDO", "odd oferecida da Dupla Chance 12; a FootyStats manda zero (#237)"),
    "odds_doublechance_x2": ("CONSUMIDO", "odd oferecida da Dupla Chance X2; ancora vem do trio 1X2 (#237)"),
    "odds_corners_over_75": ("CONSUMIDO", "escada de escanteios: linha 7.5, over (#237)"),
    "odds_corners_under_75": ("CONSUMIDO", "escada de escanteios: par do over 7.5 (#237)"),
    "odds_corners_under_85": ("CONSUMIDO", "escada de escanteios: par do over 8.5 (#237)"),
    "odds_corners_under_95": ("CONSUMIDO", "escada de escanteios: par do over 9.5 (#237)"),
    "odds_corners_under_105": ("CONSUMIDO", "escada de escanteios: par do over 10.5 (#237)"),
    "odds_corners_under_115": ("CONSUMIDO", "escada de escanteios: par do over 11.5 (#237)"),

...
CAMPOS: Dict[str, Tuple[str, str]] = {
    ...
    "cards_against_per_match_away": ("PLANEJADO", "cartoes por lado; mesma lacuna dos escanteios"),
    "cards_against_per_match_home": ("PLANEJADO", "cartoes por lado; mesma lacuna dos escanteios"),
    "cards_per_match": ("CONSUMIDO", "lido por pelo menos um consumidor no backend"),
    "cards_per_match_away": ("PLANEJADO", "cartoes por lado; mesma lacuna dos escanteios"),
    "cards_per_match_home": ("PLANEJADO", "cartoes por lado; mesma lacuna dos escanteios"),
